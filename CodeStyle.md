...
4.7.8.
Конструкции <tt style="color: red;">*(a + i)`,
<tt style="color: red;">(*p).f` запрещены.
...
STDIN_FILENO (0) - файловый дескриптор стандартного потока ввода
STDOUT_FILENO (1) - файловый дескриптор стандартного потока вывода
```

Как правило, константы 0 или 1 заменять на именованные константы не нужно.
